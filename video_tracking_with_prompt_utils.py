...
from onevision.utils.kernels.edt import edt_triton
...
class AsyncVideoFileLoaderWithTorchCodec:
    ...
    """
    logging.warning("AsyncVideoFileLoaderWithTorchCodec reached")
    ...
    def __init__(
        ...
        logging.warning("AsyncVideoFileLoaderWithTorchCodec init takes " + str(time_lapse) + "seconds")
...
def load_resource_as_video_frames(
    ...
    """
    logging.warning("load_resource_as_video_frames reached - use_torchcodec set to True")
...
def load_video_frames(
    ...
    """
    logging.warning("load_video_frames reached - use_torchCodec = True")
